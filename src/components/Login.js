...
const Login = () => {
  ...
  return (
    <div className="relative h-screen">
      <Header />
      <div
        className="absolute z-0 inset-0 bg-cover bg-no-repeat bg-center"
        style={{ backgroundImage: `url(${BACKGROUND_IMAGE_URL})` }}
      />
      <div className="absolute z-5 inset-0 flex justify-center items-center">
        <form
          onSubmit={(e) => e.preventDefault()}
          className="bg-[#000000bf] p-8 shadow-md rounded-lg w-96"
        >
          ...
          {!isSignInForm && (
            <input
              ...
              className="text-white p-2 m-2 w-full bg-[#333]"
            />
          )}
          <input
            ref={emailRef}
          ...
          <button
            className="p-4 mt-10 m-2 w-full bg-[#e50914] text-white font-semibold rounded"
